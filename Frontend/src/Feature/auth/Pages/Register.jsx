    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          gap: 56, padding: "0 20px",
          fontFamily: "'Inter', sans-serif",
        }}
      >
        {/* ── Card ── */}
        <div className="glass-card" style={{ width: 400, borderRadius: 20, padding: "36px 40px" }}>
          ...
          <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 26, fontWeight: 800, color: "#fff", letterSpacing: "-0.03em", lineHeight: 1.1, marginBottom: 4 }}>
            Start your<br />journey.
          </div>
          <div style={{ fontSize: 13, color: "rgba(255,255,255,0.35)", marginBottom: 22, fontWeight: 300 }}>
          ...
          {error && (
            <div style={{
              fontSize: 12, color: "#f43f5e", marginBottom: 12,
              padding: "9px 13px",
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: 6 }}>
              <div className="pass-wrap">
                <input
                  className={`field-input ${error.includes("match") ? "err" : ""}`}
                ...
                <div style={{ display: "flex", gap: 4, marginTop: 5 }}>
                  {[1, 2, 3, 4].map((seg) => (
                    <div key={seg} style={{
                      ...
                      background: seg <= strength ? strengthColor[strength] : "rgba(255,255,255,0.08)",
            ...
            <div style={{ marginBottom: 14 }}>
              <div className="pass-wrap">
                <input
                  ...
                  style={{ paddingRight: 50 }}
                />
                <button type="button" className="pass-eye" onClick={() => setShowConf((p) => !p)}>
                  {showConf ? "Hide" : "Show"}
                </button>
              </div>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: 8, marginBottom: 18 }}>
              <input className="custom-checkbox" type="checkbox" id="agree"
                checked={agree} onChange={(e) => setAgree(e.target.checked)} style={{ marginTop: 2 }} />
              <label htmlFor="agree" style={{ fontSize: 11, color: "rgba(255,255,255,0.3)", cursor: "pointer", lineHeight: 1.6 }}>
                I agree to the{" "}
          ...
          {/* Google */}
          <button className="social-btn" onClick={() => console.log("Google sign-up")}>
          ...
          {/* Sign in link */}
          <div style={{ textAlign: "center", marginTop: 16, fontSize: 12, color: "rgba(255,255,255,0.22)" }}>
        ...
        {/* ── Genre Side Panel ── */}
        <div style={{ width: 240 }}>
          <div style={{ fontSize: 10, letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,255,255,0.25)", marginBottom: 16 }}>
            Browse by genre
          </div>
          ...
          <div style={{ marginTop: 20, fontSize: 11, color: "rgba(255,255,255,0.15)", lineHeight: 1.7 }}>
            Join thousands of film lovers<br />building their perfect watchlist.
          </div>
        </div>
      </div>
    </>
